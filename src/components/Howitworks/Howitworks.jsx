    ...
    return (
        <>
            <div className="container-fluid" id="howItWorks">
                ...
                <h2>Encryption</h2>
                <p>
                   This app uses symetric encrpytion. The shared secret key is hashed using the <a href="https://en.wikipedia.org/wiki/SHA-2">Secure Hash Algorithm 256</a> method. The message is then encrypted using the <a href="https://en.wikipedia.org/wiki/Advanced_Encryption_Standard">Advanced Encryption Standard 256</a> method. Once the message has been encrypted, it is sent via the server to the other user, who decrypts the message at their end using the same method. 
                </p>
                <p>
